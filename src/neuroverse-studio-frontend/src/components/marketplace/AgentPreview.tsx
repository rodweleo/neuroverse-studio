  ...
  const mockExamples = [
    {
      ...
      agent:
        "I can guide you through various stress management techniques including breathing exercises, mindfulness practices, and cognitive strategies. Would you like to start with a quick 5-minute breathing exercise?",
    },
    {
      id: 2,
      user: "I'm feeling overwhelmed at work.",
      agent:
        "I understand that feeling. Let's break this down together. Can you tell me what specifically is making you feel overwhelmed? Is it the workload, deadlines, or perhaps workplace relationships?",
    },
  ];
      ...
      <DialogContent className="max-w-4xl h-[80vh] glassmorphic border-neon-blue/30 flex flex-col">
        ...
        <div className="flex-1 flex flex-col gap-6 overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            {activeTab === "examples" && (
              <div className="space-y-4">
                <p className="text-sm text-muted-foreground mb-4">
                  Here are some example conversations to help you understand how
                  this agent responds:
                </p>
                {mockExamples.map((example) => (
                  <div
                    key={example.id}
                    className="glassmorphic border border-neon-blue/20 rounded-lg p-4 space-y-3"
                  >
            ...
            {activeTab === "reviews" && <div className="space-y-4"></div>}
          </div>
