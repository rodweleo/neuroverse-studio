...
const DeployAgentPaymentModal = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-full h-full max-h-[600px] max-w-2xl bg-black/90 backdrop-blur-md overflow-hidden overflow-y-auto p-5">
          ...
          <div className="space-y-4 mt-4">
            ...
            <div className="space-y-2">
              ...
              <div className="text-sm text-muted-foreground">
                Tool creators will receive their payments directly when you
                deploy this agent.
              </div>
            </div>
